...
public class CustomerRestConnectorProvider {
    ...
    public Customer create(@RequestBody CustomerRequestWrapper customerRequestWrapper) {
    	Customer customer = customerService.insertCustomer(customerRequestWrapper.getCustomer(), customerRequestWrapper.getCart(), customerRequestWrapper.getCartItems());
